...
id=utils.id_factory('archive-dashboard-next-year')
#=====================================================================================
...
def get_Layout(next_year,data):
    ...
    if not isinstance(next_year,int):
        ...
        columnDefs,defaultColDef,getRowStyle=dataframe.get_dashboard(next_year)
        ...
        [
                    ...
                    dbc.ModalBody([
                        html.Div(
                            [
                                ...
                                dbc.Checklist(
                                    options=[
                                        {"label": f"Average data for the year {next_year}", "value": "full_year"},
                                        {"label": f"1st half of {next_year}", "value": "first_half"},
                                        {"label": f"2nd half of {next_year}", "value": "second_half"},                                    
                                    ],
                                    value=["full_year"],
            ...
            dag.AgGrid(
                id="archive-dashboard-next-year",
...
@app.callback(Output('archive-dashboard-next-year','filterModel',allow_duplicate=True),
...
@app.callback(
    Output('archive-dashboard-next-year', "columnState"),
    Input(id("columns_to_hide"), "value"),
    State('archive-dashboard-next-year', "columnState"),
    prevent_initial_call=True,
)
    ...
    for service in selected_services:
        ...
        for timeframe in selected_timeframe:
            if timeframe=="full_year":
                ...
                row= html.Div([
                    html.H3(f"{service}/{code} (average data for the year {archive.next_year}):",style={"marginTop":"20px"}),
                    dbc.Row([
            ...
            if timeframe=="first_half":
                ...
                row= html.Div([
                    html.H3(f"{service}/{code} (average data for the 1st half of {archive.next_year}):",style={"marginTop":"20px"}),
                    dbc.Row([
                        dbc.Col([html.H4("Workload :",style={"fontWeight":"normal","fontSize":"xx-large"}), html.P(f"{workload} FTEs",style={"fontWeight":"bold","fontSize":"x-large"}), html.P("a",style={"fontSize":"large","opacity":0}), html.P("a",style={"fontSize":"large","opacity":0})],style={"textAlign":"center"}),
                        dbc.Col([html.H4("Workforce :",style={"fontWeight":"normal","fontSize":"xx-large"}), html.P(f"{workforce} FTEs",style={"fontWeight":"bold","fontSize":"x-large"}), html.P([f"- Headcounts:",html.B(f" {hc} FTEs")],style={"fontSize":"large"}), html.P([f"- Contractors:",html.B(f" {cont} FTEs")],style={"fontSize":"large"})],style={"textAlign":"center"}),
                        dbc.Col(dcc.Graph(figure=fig_cover)),
            ...
            if timeframe=="second_half":
                ...
                row= html.Div([
                    html.H3(f"{service}/{code} (average data for the 2nd half of {archive.next_year}):",style={"marginTop":"20px"}),
                    dbc.Row([
                        dbc.Col([html.H4("Workload :",style={"fontWeight":"normal","fontSize":"xx-large"}), html.P(f"{workload} FTEs",style={"fontWeight":"bold","fontSize":"x-large"}), html.P("a",style={"fontSize":"large","opacity":0}), html.P("a",style={"fontSize":"large","opacity":0})],style={"textAlign":"center"}),
                        dbc.Col([html.H4("Workforce :",style={"fontWeight":"normal","fontSize":"xx-large"}), html.P(f"{workforce} FTEs",style={"fontWeight":"bold","fontSize":"x-large"}), html.P([f"- Headcounts:",html.B(f" {hc} FTEs")],style={"fontSize":"large"}), html.P([f"- Contractors:",html.B(f" {cont} FTEs")],style={"fontSize":"large"})],style={"textAlign":"center"}),
                        dbc.Col(dcc.Graph(figure=fig_cover)),
...
@app.callback(
    Output('archive-dashboard-next-year',"dashGridOptions",allow_duplicate=True),
    Input('archive-dashboard-next-year', "selectedRows"),
)

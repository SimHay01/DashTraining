...
id=utils.id_factory('archive-dashboard-year-two')
#=====================================================================================
...
def get_Layout(next_next_year,data):
...
@app.callback(Output('archive-dashboard-year-two','filterModel',allow_duplicate=True),
...
@app.callback(
    Output('archive-dashboard-year-two', "columnState"),
    Input(id("columns_to_hide"), "value"),
    State('archive-dashboard-year-two', "columnState"),
    prevent_initial_call=True,
)
    ...
    for service in selected_services:
        ...
        for timeframe in selected_timeframe:
            if timeframe=="full_year":
                ...
                row= html.Div([
                    html.H3(f"{service}/{code} (average data for the year {archive.next_next_year}):",style={"marginTop":"20px"}),
                    dbc.Row([
            ...
            if timeframe=="first_half":
                ...
                row= html.Div([
                    html.H3(f"{service}/{code} (average data for the 1st half of {archive.next_next_year}):",style={"marginTop":"20px"}),
                    dbc.Row([
                        dbc.Col([html.H4("Workload :",style={"fontWeight":"normal","fontSize":"xx-large"}), html.P(f"{workload} FTEs",style={"fontWeight":"bold","fontSize":"x-large"}), html.P("a",style={"fontSize":"large","opacity":0}), html.P("a",style={"fontSize":"large","opacity":0})],style={"textAlign":"center"}),
                        dbc.Col([html.H4("Workforce :",style={"fontWeight":"normal","fontSize":"xx-large"}), html.P(f"{workforce} FTEs",style={"fontWeight":"bold","fontSize":"x-large"}), html.P([f"- Headcounts:",html.B(f" {hc} FTEs")],style={"fontSize":"large"}), html.P([f"- Contractors:",html.B(f" {cont} FTEs")],style={"fontSize":"large"})],style={"textAlign":"center"}),
                        dbc.Col(dcc.Graph(figure=fig_cover)),
            ...
            if timeframe=="second_half":
                ...
                row= html.Div([
                    html.H3(f"{service}/{code} (average data for the 2nd half of {archive.next_next_year}):",style={"marginTop":"20px"}),
                    dbc.Row([
                        dbc.Col([html.H4("Workload :",style={"fontWeight":"normal","fontSize":"xx-large"}), html.P(f"{workload} FTEs",style={"fontWeight":"bold","fontSize":"x-large"}), html.P("a",style={"fontSize":"large","opacity":0}), html.P("a",style={"fontSize":"large","opacity":0})],style={"textAlign":"center"}),
                        dbc.Col([html.H4("Workforce :",style={"fontWeight":"normal","fontSize":"xx-large"}), html.P(f"{workforce} FTEs",style={"fontWeight":"bold","fontSize":"x-large"}), html.P([f"- Headcounts:",html.B(f" {hc} FTEs")],style={"fontSize":"large"}), html.P([f"- Contractors:",html.B(f" {cont} FTEs")],style={"fontSize":"large"})],style={"textAlign":"center"}),
                        dbc.Col(dcc.Graph(figure=fig_cover)),
...
@app.callback(
    Output('archive-dashboard-year-two',"dashGridOptions",allow_duplicate=True),
    Input('archive-dashboard-year-two', "selectedRows"),
)

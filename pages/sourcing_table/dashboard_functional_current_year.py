...
id=utils.id_factory('dashboard_func_current_year')
...
def get_Layout():
    ...
    columnDefs,defaultColDef,getRowStyle=dataframe.get_dashboard_functional(year)
    layout=html.Div(
        [
            ...
            dag.AgGrid(
                ...
                rowData=dataframe.get_dataframe_functional(dataframe.dashboard_func,dataframe.simu_func,year,next_year,next_next_year).to_dict("records"),
